...
class ViewTodayConsumption extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ClientService.getViewToday(this.state.id).then((res) => {
    ...
    render() {
        return (
            <div>
                <h2 className="text-center">Consumption today</h2>
                <br/>
                <div className="row">
...
export default withRouter(ViewTodayConsumption);